...
class getAdminControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.2h6BSJb'] ?? $container->load('get_ServiceLocator_2h6BSJbService'))->withContext('App\\Controller\\AdminController', $container));
