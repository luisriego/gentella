...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventListener/ForcePasswordChange.php';
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/RedirectToLocaleSubscriber.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('2HrW871ED9', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FSflKDczfO', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hvBG7gk1lX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'App\\EventListener\\ForcePasswordChange')] function () {
            return ($this->privates['App\\EventListener\\ForcePasswordChange'] ?? $this->getForcePasswordChangeService());
        }, 1 => 'onKernelRequestE'], 0);
    ...
    /**
     * Gets the private 'App\EventListener\ForcePasswordChange' shared autowired service.
     *
     * @return \App\EventListener\ForcePasswordChange
     */
    protected function getForcePasswordChangeService()
    {
        $a = ($this->privates['security.helper'] ?? $this->getSecurity_HelperService());

        if (isset($this->privates['App\\EventListener\\ForcePasswordChange'])) {
            return $this->privates['App\\EventListener\\ForcePasswordChange'];
        }

        return $this->privates['App\\EventListener\\ForcePasswordChange'] = new \App\EventListener\ForcePasswordChange($a, ($this->services['router'] ?? $this->getRouterService()));
    }
    ...
    {
        return $this->privates['App\\EventSubscriber\\RedirectToLocaleSubscriber'] = new \App\EventSubscriber\RedirectToLocaleSubscriber(($this->services['router'] ?? $this->getRouterService()), 'fr|en', 'fr');
    }
    ...
    {
        return $this->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MfORPLvFna', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSecurity_EventDispatcher_MainService()
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => #[\Closure(name: 'security.listener.login_throttling.main', class: 'Symfony\\Component\\Security\\Http\\EventListener\\LoginThrottlingListener')] function () {
            return ($this->privates['security.listener.login_throttling.main'] ?? $this->load('getSecurity_Listener_LoginThrottling_MainService'));
        }, 1 => 'checkPassport'], 2080);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginFailureEvent', [0 => #[\Closure(name: 'security.listener.login_throttling.main', class: 'Symfony\\Component\\Security\\Http\\EventListener\\LoginThrottlingListener')] function () {
            return ($this->privates['security.listener.login_throttling.main'] ?? $this->load('getSecurity_Listener_LoginThrottling_MainService'));
        }, 1 => 'onFailedLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => #[\Closure(name: 'security.listener.login_throttling.main', class: 'Symfony\\Component\\Security\\Http\\EventListener\\LoginThrottlingListener')] function () {
            return ($this->privates['security.listener.login_throttling.main'] ?? $this->load('getSecurity_Listener_LoginThrottling_MainService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        ...
        return [
            ...
            'security.role_hierarchy.roles' => [
                'ROLE_SUPERUSER' => [
                    ...
                    2 => 'ROLE_WRITER',
                    3 => 'ROLE_USER',
                    4 => 'ROLE_ENABLE_PROFILE',
                    5 => 'ROLE_EDIT_PROFILE',
                    6 => 'ROLE_ADD_PROFILE',
                    7 => 'ROLE_AG_ENABLE_USER',
                    8 => 'ROLE_AG_DELETE_USER',
                    9 => 'ROLE_RESET_PASSWORD_USER',
                    10 => 'ROLE_DELETE_USER',
                    11 => 'ROLE_ENABLE_USER',
                    12 => 'ROLE_ADD_USER',
                    13 => 'ROLE_VIEW_USER',
                    14 => 'ROLE_EDIT_USER',
                    15 => 'ROLE_AG_ENABLE_PROFILE',
                    16 => 'ROLE_AG_DELETE_PROFILE',
                    17 => 'ROLE_DELETE_PROFILE',
                ],
                'ROLE_ACCESS_MENU_MANAGE_PROFILE' => [
                    0 => 'ROLE_ACCESS_MENU_USER',
                    1 => 'ROLE_ADMIN',
                ],
                'ROLE_LIST_PROFILE' => [
                    0 => 'ROLE_ACCESS_MENU_MANAGE_PROFILE',
                ],
                'ROLE_EDIT_PROFILE' => [
                    0 => 'ROLE_LIST_PROFILE',
                ],
                ...
                'ROLE_ACCESS_MENU_MANAGE_USER' => [
                    0 => 'ROLE_ACCESS_MENU_USER',
                    1 => 'ROLE_ADMIN',
                ],
                'ROLE_LIST_USER' => [
                    0 => 'ROLE_ACCESS_MENU_MANAGE_USER',
                ],
                'ROLE_EDIT_USER' => [
                    0 => 'ROLE_LIST_USER',
                ],
                ...
                'ROLE_ACCESS_MENU_MANAGE_CATEGORIE' => [
                    0 => 'ROLE_ACCESS_MENU_CATEGORIE',
                    1 => 'ROLE_ADMIN',
                ],
                'ROLE_LIST_CATEGORIE' => [
                    0 => 'ROLE_ACCESS_MENU_MANAGE_CATEGORIE',
                ],
                'ROLE_EDIT_CATEGORIE' => [
                    0 => 'ROLE_LIST_CATEGORIE',
                ],
                'ROLE_ADD_CATEGORIE' => [
                    0 => 'ROLE_LIST_CATEGORIE',
                ],
                ...
                'ROLE_ACCESS_MENU_MANAGE_GENERAL' => [
                    0 => 'ROLE_ACCESS_MENU_PARAMETRE',
                    1 => 'ROLE_ADMIN',
                ],
                'ROLE_ACCESS_MENU_MANAGE_FAQ' => [
                    0 => 'ROLE_ACCESS_MENU_PARAMETRE',
                    1 => 'ROLE_ADMIN',
                ],
                'ROLE_LIST_FAQ' => [
                    0 => 'ROLE_ACCESS_MENU_MANAGE_FAQ',
                ],
                'ROLE_EDIT_FAQ' => [
                    0 => 'ROLE_LIST_FAQ',
                ],
                ...
                'ROLE_ACCESS_MENU_MANAGE_INBOX' => [
                    0 => 'ROLE_ACCESS_MENU_CONTACT',
                    1 => 'ROLE_ADMIN',
                ],
                'ROLE_ACCESS_MENU_MANAGE_BLOG' => [
                    0 => 'ROLE_ACCESS_MENU_BLOG',
                    1 => 'ROLE_ADMIN',
                    2 => 'ROLE_ACCESS_MENU_MANAGE_HISTORYBLOG',
                ],
                'ROLE_LIST_BLOG' => [
                    0 => 'ROLE_ACCESS_MENU_MANAGE_BLOG',
                ],
                'ROLE_EDIT_BLOG' => [
                    0 => 'ROLE_LIST_BLOG',
                ],
                ...
                'ROLE_ACCESS_MENU_MANAGE_HISTORYBLOG' => [
                    0 => 'ROLE_ACCESS_MENU_BLOG',
                    1 => 'ROLE_ADMIN',
                ],
                'ROLE_LIST_HISTORYBLOG' => [
                    0 => 'ROLE_ACCESS_MENU_MANAGE_HISTORYBLOG',
                ],
                'ROLE_VIEW_HISTORYBLOG' => [
                    0 => 'ROLE_LIST_HISTORYBLOG',
                ],
