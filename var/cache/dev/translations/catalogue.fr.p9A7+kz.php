...
$catalogue = new MessageCatalogue('fr', array (
  ...
  'messages' => 
  array (
    'backend.global.welcome' => 'Bienvenue',
    'backend.global.you_are_logged' => 'Vous êtes connecté en tant que',
    'backend.global.leave_impersonate' => 'Quitter l\'impersonnation',
    'backend.global.change_my_password' => 'Changer mon mot de passe',
    'backend.global.logout' => 'Deconnexion',
    'backend.global.error' => 'Erreur',
    'backend.global.success' => 'Success',
    'backend.global.an_unexpected_error' => 'Une erreur innatendue est survenue',
    'backend.global.must_not_be_empty' => 'Ne doit pas être vide',
    'backend.global.please_confirm' => 'Veuillez confirmer votre action?',
    'backend.global.choice_action' => 'Selectionner une action',
    'backend.global.no_item_selected' => 'Aucun article selectionné',
    'backend.global.save' => 'Enregistrer',
    'backend.menu.home' => 'Accueil',
    'backend.menu.user' => 'Utilisateur',
    'backend.menu.manage' => 'Gérer',
    'backend.menu.profil' => 'Profile utilisateur',
    'backend.menu.categories' => 'Categorie',
    'backend.menu.blog' => 'Blog',
    'backend.menu.history' => 'Historique',
    'backend.menu.settings' => 'Parametre',
    'backend.menu.general' => 'Génerale',
    'backend.menu.faq' => 'FAQ',
    'backend.menu.contact' => 'Conctact',
    'backend.menu.inbox' => 'Boîte de reception',
    'backend.role.choice_role' => 'Choisissez un role',
    'backend.user.listing' => 'Listing',
    'backend.user.user_listing' => 'Liste des utilisateurs',
    'backend.user.group_actions' => 'Action de groupe',
    'backend.user.deactivate' => 'Désactiver',
    'backend.user.Activate' => 'Activer',
    'backend.user.delete' => 'Supprimer',
    'backend.user.username' => 'Nom d\'utilisateur',
    'backend.user.email' => 'Email',
    'backend.user.name' => 'Nom Complet',
    'backend.user.modifier' => 'Modifier',
    'backend.user.status' => 'Etat ?',
    'backend.user.password' => 'Mot de passe',
    'backend.user.cancel' => 'Annuler',
    'backend.user.register' => 'Enregistrer',
    'backend.user.changer_password' => 'Changer de mot de passe',
    'backend.user.changer_my_password' => 'Changer mon mot de passe',
    'backend.user.current_password' => 'Mot de passe actuel',
    'backend.user.new_password' => 'Nouveau mot de passe',
    'backend.user.confirm_password' => 'Confirmé mot de passe',
    'backend.user.remember_password' => 'Veuiller votre mot de passe actuel',
    'backend.user.new_passwod_must_be' => 'Les nouveaux mot de passe doivent être identique.',
    'backend.user.changed_password' => 'Mot de passe modifié',
    'backend.user.add_user' => 'Utilisateur ajouté',
    'backend.user.modify_user' => 'Utilisateur modifié',
    'backend.user.new_user' => 'Nouvel utilisateur',
    'backend.user.edit_user' => 'Modifier utilisateur',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  'messages' => 
  array (
    'backend.global.welcome' => 'Welcome',
    'backend.global.you_are_logged' => 'You are logged in as',
    'backend.global.leave_impersonate' => 'Leaving impersonation',
    'backend.global.change_my_password' => 'Change my password',
    'backend.global.logout' => 'Logout',
    'backend.global.error' => 'Error',
    'backend.global.success' => 'Success',
    'backend.global.an_unexpected_error' => 'An unexpected error has occurred',
    'backend.global.must_not_be_empty' => 'Must not be empty',
    'backend.global.please_confirm' => 'Please confirm your action?',
    'backend.global.choice_action' => 'Select an action',
    'backend.global.no_item_selected' => 'No items selected',
    'backend.global.save' => 'Save',
    'backend.menu.home' => 'Home',
    'backend.menu.user' => 'User',
    'backend.menu.profil' => 'User profile',
    'backend.menu.manage' => 'Manage',
    'backend.menu.categories' => 'Categories',
    'backend.menu.blog' => 'Blog',
    'backend.menu.history' => 'History',
    'backend.menu.settings' => 'Settings',
    'backend.menu.general' => 'General',
    'backend.menu.faq' => 'FAQ',
    'backend.menu.contact' => 'Conctact',
    'backend.menu.inbox' => 'Inbox',
    'backend.role.choice_role' => 'Choose a role',
    'backend.user.listing' => 'Listing',
    'backend.user.user_listing' => 'List of users',
    'backend.user.group_actions' => 'Group action',
    'backend.user.deactivate' => 'Deactivate',
    'backend.user.Activate' => 'Activate',
    'backend.user.delete' => 'Delete',
    'backend.user.username' => 'Username',
    'backend.user.email' => 'Email',
    'backend.user.name' => 'Full Name',
    'backend.user.modifier' => 'Edit',
    'backend.user.status' => 'Status',
    'backend.user.password' => 'Password',
    'backend.user.cancel' => 'Cancel',
    'backend.user.register' => 'Register',
    'backend.user.changer_password' => 'Change Password',
    'backend.user.changer_my_password' => 'Change my password',
    'backend.user.current_password' => 'Current password',
    'backend.user.new_password' => 'New password',
    'backend.user.confirm_password' => 'Confirm password',
    'backend.user.remember_password' => 'Remember your current password',
    'backend.user.new_passwod_must_be' => 'The new passwords must be identical.',
    'backend.user.changed_password' => 'Changed password',
    'backend.user.add_user' => 'Added user',
    'backend.user.modify_user' => 'Modified user',
    'backend.user.new_user' => 'New user',
    'backend.user.edit_user' => 'Edit user',
    'backend.login.new_site' => 'New to site?',
    'backend.login.create_acount' => 'Create Account',
    'backend.login.all_rights' => 'All Rights Reserved.',
    'backend.login.already_member' => 'Already a member?',
    'backend.login.log_in' => 'Log in',
  ),
));
