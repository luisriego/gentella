...
class getBlogPostRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\BlogPostRepository'])) {
            return $container->privates['App\\Repository\\BlogPostRepository'];
        }

        return $container->privates['App\\Repository\\BlogPostRepository'] = new \App\Repository\BlogPostRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), $a);
    }
}
